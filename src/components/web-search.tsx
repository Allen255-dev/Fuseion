      ...
      <div className="bg-[#1a1a1a]/95 border border-white/10 rounded-2xl w-full max-w-2xl max-h-[85vh] flex flex-col shadow-2xl animate-in fade-in zoom-in duration-200">
        ...
        <div className="flex items-center justify-between p-5 border-b border-white/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-white">Search the Web</h2>
              <p className="text-xs text-muted-foreground">Powered by DuckDuckGo</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-5 scrollbar-thin scrollbar-thumb-white/10">
          {isSearching && (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground animate-pulse">Searching the deep web...</p>
            </div>
          )}
                ...
                <div key={idx} className="group">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 text-[10px] text-muted-foreground/40 font-mono uppercase tracking-wider">
                      <span className="px-1.5 py-0.5 bg-white/5 rounded border border-white/5">{result.source}</span>
                      <span className="truncate flex-1 hover:text-blue-400/60 transition-colors uppercase">{result.url}</span>
                    </div>
                  </button>
                </div>
              ))}
